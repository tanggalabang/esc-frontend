...
// import moc_up from '/assets/images/mocup2-removebg.png';
  ...
  return (
    <>
      <section className="slider-area fix">
        ...
        <div className="single-slider slider-height-3 d-flex">
            ...
            <div className="row">
              ...
              <div className="col-xl-6 col-lg-6">
                ...
                <div className="slider-img slider-img-3 wow fadeInRight animated" data-wow-duration="2.5s">
                  {/* <Image src={moc_up} alt="theme-pure" height={700} /> */}
                </div>
              </div>
            </div>
          </div>
      ...
      {/* video modal start */}
      {/* <VideoPopup isVideoOpen={isVideoOpen} setIsVideoOpen={setIsVideoOpen} videoId={'olboi3ttUi8'} /> */}
      {/* video modal end */}
    </>
  );
};
