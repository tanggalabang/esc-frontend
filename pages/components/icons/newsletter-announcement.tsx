export default function NewsletterAnnouncement({
  ...
  return (
    <svg xmlns="http://www.w3.org/currentColor/svg" viewBox="0 0 20 20" fill="none" {...props}>
      ...
      />
      <path fill="#78909C" d="m6.52 8.865 1.162-.459 1.12 2.838-1.162.46-1.12-2.839Z" />
      <path fill="#90A4AE" d="M7.434 6.074 4.527 7.221l.918 2.326L8.352 8.4l-.918-2.326Z" />
